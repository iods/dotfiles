...
# Disable “natural” (Lion-style) scrolling
defaults write NSGlobalDomain com.apple.swipescrolldirection -bool false
# Disable "forceClick" lookup behavior
defaults write NSGlobalDomain com.apple.trackpad.forceClick -bool false
# Enable Tap to Click
defaults write com.apple.AppleMultitouchTrackpad Clicking -bool true
# Disable Force Click & Haptic Feedback
defaults write com.apple.AppleMultitouchTrackpad ActuateDetents -bool false
defaults write com.apple.AppleMultitouchTrackpad ForceSuppressed -bool true
# Set preferred swiping behavior
defaults write com.apple.AppleMultitouchTrackpad AppleEnableSwipeNavigateWithScrolls -int 0
...
# 	MENU_OTHER
#
#   nonrational: SOURCE enables calculator?
...
################################################################
#                        _                           _        _
#  ___ _   _ _ __  _ __ | | ___ _ __ ___   ___ _ __ | |_ __ _| |
# / __| | | | '_ \| '_ \| |/ _ \ '_ ` _ \ / _ \ '_ \| __/ _` | |
# \__ \ |_| | |_) | |_) | |  __/ | | | | |  __/ | | | || (_| | |
# |___/\__,_| .__/| .__/|_|\___|_| |_| |_|\___|_| |_|\__\__,_|_|
#           |_|   |_|                                nonrational
################################################################

# Enable Do Not Disturb All The Time
defaults -currentHost write ~/Library/Preferences/ByHost/com.apple.notificationcenterui doNotDisturb -boolean true
defaults -currentHost write ~/Library/Preferences/ByHost/com.apple.notificationcenterui dndEnd -float 119 # 01:59
defaults -currentHost write ~/Library/Preferences/ByHost/com.apple.notificationcenterui dndStart -float 120 # 02:00

# Remove Time, Battery, Airplay from Menu Bar
...
# Stop the "Try Safari!" nagification
...
# https://github.com/mathiasbynens/dotfiles/pull/774/files
hidutil property --set '{"UserKeyMapping":[{"HIDKeyboardModifierMappingSrc":0x700000039,"HIDKeyboardModifierMappingDst":0x7000000E0}]}'

# Indirect GLX was disabled by default in Xorg 1.17, starting from XQuartz version 2.7.9,
# to enable indirect GLX and to allow remote visualization on the cluster you will have to issue at the terminal command prompt of your mac:
